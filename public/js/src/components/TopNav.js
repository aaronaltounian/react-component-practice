        ...
        <ul className="nav navbar-right top-nav">
            <li className="dropdown">
                ...
                <ul className="dropdown-menu message-dropdown">
                    ...
                    {/*  <MessagePreview>   */}
                    <MessagePreview from="Collin B." message="Everyone agrees you are the best." />
                    {/*  </MessagePreview>   */}
            ...
            <li className="dropdown">
                <a href="#" className="dropdown-toggle" data-toggle="dropdown"><i className="fa fa-user"></i>{props.user}
